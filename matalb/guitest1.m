...
% Last Modified by GUIDE v2.5 28-Sep-2013 23:56:39
...
% --- Executes on button press in butSQ.
function butSQ_Callback(hObject, eventdata, handles)
% hObject    handle to butSQ (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
k=1;
while(k<=10)&&ishandle(hObject)  %если объект существует с сылкой hObject то 1
    cla
...
% --- Executes on button press in btnCir.
function btnCir_Callback(hObject, eventdata, handles)
% hObject    handle to btnCir (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
k=1;
 while(k<=10)&&ishandle(hObject) %если объект существует с сылкой hObject то 1

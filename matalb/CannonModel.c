 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Fri Sep 20 09:11:28 2013
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME CannonModel
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void CannonModel_Outputs_wrapper(const real_T *u0,
                          const real_T *u1,
                          real_T *y0,
                          real_T *y1 ,
			   const real_T *xC,
                          const real_T  *k, const int_T  p_width0, 
                          const real_T  *g, const int_T p_width1);
extern void CannonModel_Derivatives_wrapper(const real_T *u0,
                          const real_T *u1,
                          const real_T *y0,
                          const real_T *y1,
                          real_T *dx ,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T  *g  = (const real_T *)mxGetData(PARAM_DEF1(S));

    CannonModel_Outputs_wrapper(u0, u1, y0, y1, xC, k, p_width0, g, p_width1);
}
...
/* Function: mdlDerivatives =================================================
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    CannonModel_Derivatives_wrapper(u0, u1, y0, y1,dx,  xC, k, p_width0, g, p_width1);
}
